...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getAllByUser(long userId, BookingRequestState state, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> getAllByOwner(long userId, BookingRequestState state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
